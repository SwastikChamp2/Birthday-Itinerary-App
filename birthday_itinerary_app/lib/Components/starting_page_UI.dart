...
class StartingPageUI extends StatefulWidget {
  const StartingPageUI({super.key});

  @override
  State<StartingPageUI> createState() => _StartingPageUIState();
}

class _StartingPageUIState extends State<StartingPageUI> {
  @override
